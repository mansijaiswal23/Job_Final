      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div className="flex items-center mb-6 md:mb-0">
            <p className=" flex flex-wrap gap-4 max-w-md text-large text-bold  text-gray-2400 ml-2 ">Give us a Call <span className="font-normal text-gray-500">99999 99999</span></p>
          </div>
          </div>
         </div>
        ...
        <div className=" mt-6 pt-4 text-xs text-gray-500 text-right mb-18 md:mb-22 -mt-24 ">
